...
export default function Viewer() {
  ...
  const getImages = async () => {
    const response = await fetch("https://webappimages.blob.core.windows.net/dzi/pictures3.json", {
                              method: 'GET',
                              credentials: 'include',
                              headers: {'Access-Control-Allow-Credentials': 'true', 'Access-Control-Allow-Origin': 'https://gray-dune-0f8914010.azurestaticapps.net'}}); //api/deepzoom/pictures3.json""https://miradortest.z13.web.core.windows.net/pictures3.json
